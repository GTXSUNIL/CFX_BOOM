...
bot.on('ready', () => {
    console.info(`TEAM TX${bot.user.tag}!`);
});

bot.login("OTI1MTMzMjAwNjg1MTQyMDg3.Ycorbw.fnzLSBNZu_MCKfLjTLUdBl6OvJs")
...
bot.on('message', msg => {
    ...
    if(msg.content.startsWith("!find")){
        ...
        .addField("\<:ip:820801530172801035> Get Server IP", "`!ip [cfx code]`")
        .addField("\<:logo:820801824050905129> Get Server Logo", "`!logo [cfx code]`")
        .addField("\<:tags:820801679208349737> Get Server Tags", "`!tags [cfx code]`")
        .setFooter("TEAM TX")
        msg.channel.send(mensaje);
